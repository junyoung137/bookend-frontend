    ...
    <div className="space-y-2.5 w-full max-w-3xl mx-auto p-3 relative">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="flex items-center justify-center w-10 h-10 rounded-lg bg-gradient-to-br from-blue-500 to-purple-600 shadow">
        ...
        <div className="flex flex-col items-end gap-1.5">
          <div className="flex items-center gap-2">
            <button
              ...
              className="px-2 py-1 rounded-lg bg-blue-50 hover:bg-blue-100 transition-colors flex items-center gap-1"
            >
              <Settings className="w-3 h-3 text-blue-600" />
              <span className="text-xs font-medium text-blue-600">목표</span>
            </button>
            <button
              onClick={handleReset}
              className="px-2 py-1 rounded-lg bg-red-50 hover:bg-red-100 transition-colors flex items-center gap-1"
            >
      ...
      <div className="grid grid-cols-3 gap-2.5">
        ...
        <div className="space-y-2">
          <div className="p-2.5 rounded-lg bg-gradient-to-br from-yellow-50 to-amber-50 border border-yellow-200">
            <div className="flex items-center justify-between mb-1.5">
              <div className="flex items-center gap-1.5">
                <Trophy className="w-4 h-4 text-yellow-600" />
                <span className="text-xs font-bold text-gray-800">작가 레벨</span>
              </div>
              <span className="text-sm font-bold text-yellow-600">Lv.{Math.floor(data.totalWords / 1000)}</span>
            </div>
          ...
          <div className="p-2.5 rounded-lg bg-white border border-gray-200">
            <div className="flex items-center justify-between mb-1.5">
              ...
              <span className="text-[9px] font-bold text-yellow-600">{unlockedBadgesCount}/{data.badges.length}</span>
            </div>
